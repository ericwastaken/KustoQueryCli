...
Usage examples:
  python tests/manual/test-mcp-stdio-server-login.py --subscription-id <SUB_ID>
  python tests/manual/test-mcp-stdio-server-login.py --subscription-id <SUB_ID> --docker
"""
