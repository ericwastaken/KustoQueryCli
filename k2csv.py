import argparse
from app.lib.KustoHandler import execute_adx_query
from app.lib.AzureCliHelper import check_azure_cli_logged_in

# Check that the user is logged in to Azure CLI (this will raise an exception if not)
check_azure_cli_logged_in()

# Parse command-line arguments
parser = argparse.ArgumentParser(description='Query Azure Data Explorer from a query file and output results as CSV.')
...
df = execute_adx_query(args.adxUrl, args.database, query)
